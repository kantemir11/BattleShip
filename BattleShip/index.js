...
(function (root, factory) {
    ...
    SeeBattle.prototype = {
        ...
        startNewGame: function(){
            ...
            this.pcName = this.pcName || prompt('Opponent Name', '');
        ...
        updateToolbar: function(){
            this.toolbar.innerHTML = 'Score - ' + this._pcHits + ':' + this._userHits;
            if(this.isGameStopped()){
                if(this._userHits >= this._hitsForWin){
                    this.toolbar.innerHTML += ', You Won';
                }else{
                    this.toolbar.innerHTML += ', You Lost';
                }
            }else if(this.isPCGoing()){
                this.toolbar.innerHTML += ', Opponent move';
            }else{
                this.toolbar.innerHTML += ', Your move';
            }
        },
    };
